...
import { ArrowUpDown, Filter, Loader2, Plus, Search, Monitor } from "lucide-react"
                                ...
                                <TableRow>
                                    <TableCell colSpan={7} className="h-32 text-center">
                                        <div className="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p>No se encontraron estaciones de trabajo con los filtros aplicados</p>
            ...
            <CardFooter className="flex justify-between items-center border-t border-blue-100 p-4">
                <div className="text-sm text-gray-500">
                    {isLoading ? (
                        ...
                        <>
                            Mostrando {filteredWorkstations.length} de {total} estaciones
                        </>
                    )}
                </div>
                ...
                <Pagination>
                    <PaginationContent>
                        <PaginationItem>
                            <PaginationPrevious
                                onClick={() => fetchWorkstations(Math.max(currentPage - 1, 1))}
                        ...
                        {totalPages > 6 ? (
                            <>
                                <PaginationItem>
                                    <PaginationLink onClick={() => fetchWorkstations(1)} isActive={currentPage === 1}>
                                        1
                                    </PaginationLink>
                                </PaginationItem>
                                ...
                                {[...Array(totalPages)]
                                    ...
                                    .map((page) => (
                                        <PaginationItem key={page}>
                                            <PaginationLink onClick={() => fetchWorkstations(page)} isActive={currentPage === page}>
                                                {page}
                                            </PaginationLink>
                                        </PaginationItem>
                                    ))}
                                ...
                                <PaginationItem>
                                    <PaginationLink onClick={() => fetchWorkstations(totalPages)} isActive={currentPage === totalPages}>
                                        {totalPages}
                                    </PaginationLink>
                                </PaginationItem>
                            </>
                            ...
                            [...Array(totalPages)].map((_, i) => (
                                <PaginationItem key={i}>
                                    <PaginationLink onClick={() => fetchWorkstations(i + 1)} isActive={currentPage === i + 1}>
                                        {i + 1}
                                    </PaginationLink>
                                </PaginationItem>
                            ))
                        ...
                        <PaginationItem>
                            <PaginationNext
                                onClick={() => fetchWorkstations(Math.min(currentPage + 1, totalPages))}
