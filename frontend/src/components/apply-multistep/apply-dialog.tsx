...
import {BikeIcon as Motorcycle, Car, Cross, Heart, HeartPulse, Home, ShieldCheck, User} from 'lucide-react'
...
export default function InsuranceForm() {
    ...
    const insuranceCards = {
        ...
        noPatrimonial: [
            ...
            {icon: User, title: "Accidentes personales", description: "Accidentes Personales"},
                ...
                {!insuranceType ? (
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between border-b pb-4">
                            <Button
                                variant="ghost"
                                onClick={() => step > 1 ? setStep(step - 1) : setInsuranceType(null)}
                            >
                                Atrás
                            </Button>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input
                                                                    placeholder="Ingresa el número de documento" {...field} />
                                                            </FormControl>
                                                            <FormMessage/>
                                                        </FormItem>
                                                    )}
                                            ...
                                            <FormField
                                                ...
                                                render={({field}) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input
                                                                placeholder="Ingresa el número de cuenta" {...field} />
                                                        </FormControl>
                                                        <FormMessage/>
                                                    </FormItem>
                                                )}
