...
```
cd existing_repo
git remote add origin https://gitlab.com/shake-again-customers/fma-brokers-new-architecture.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/shake-again-customers/fma-brokers-new-architecture/-/settings/integrations)
